<script type="text/javascript"
        src="<?php echo base_url() . "assets/js/custom/objeto_aprendizaje_editar.js" ?>"></script>
                    ...
                    <div id="slides">
                        <div class="slides_container"
                            ...
                            <div class="titulo_contenido">
                                <h1>Editar Objeto de Aprendizaje</h1>
                            </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="form_add" data-toggle="validator">
                                            ...
                                            <div class="col-lg-10">
                                                <select name="id_curso" id="id_curso" aria-controls="datatable"
                                                    ...
                                                    foreach ($result_cursos as $resultado_cursos) {
                                                        ...
                                                        <option value="<?php echo $resultado_cursos->id_curso; ?>" <?php
                                                        if ($resultado_cursos->id_curso == $resultado->id_curso) {
                                                            ?>
                                                            selected="selected"
                                                        <?php
                                                        }
                                        ...
                                        <input type="hidden" value="<?php echo $resultado->id_objeto_aprendizaje; ?>"
                                               id="id_oculto" name="id_oculto"/>
                                    </form>
                                </div>
                            </div>
                        </div>
