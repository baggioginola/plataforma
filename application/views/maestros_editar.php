...
<script type="text/javascript" src="<?php echo base_url() . "assets/js/custom/maestros_editar.js" ?>"></script>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="form_add" data-toggle="validator">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="email" class="form-control" id="id_email"
                                                       ...
                                                       value="<?php echo $resultado->e_mail; ?>">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="id_apellido_paterno"
                                                       ...
                                                       value="<?php echo utf8_encode($resultado->apellido_paterno); ?>">
                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="id_apellido_materno"
                                                       ...
                                                       value="<?php echo utf8_encode($resultado->apellido_materno); ?>">
                                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                                            </div>
                                        </div>
                                        ...
                                        <input type="hidden" name="password_oculto" id="id_password_oculto"
                                               value="<?php echo $resultado->password ?>"/>
                                        <input type="hidden" name="id_oculto" id="id_oculto"
                                               value="<?php echo $resultado->id_maestro ?>"/>
