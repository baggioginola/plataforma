...
<script src="<?php echo base_url() . "assets/js/custom/maestros.js" ?>"></script>
<header>
    <div class="main">
                    ...
                    <div id="slides">
                        <div class="slides_container"
                            ...
                            <div class="titulo_contenido">
                                <h1 style="margin-bottom:10px; text-transform:capitalize; font-size:24px">Maestros</h1>
                            </div>

                            <div style="float:right;  margin-right:50px; clear: both;">

                                <a href="<?php echo site_url() . "?c=maestros&m=agregar" ?>"
                                   style="text-decoration:none; color:#000000; ">

                                    <img border="0" align="absmiddle" hspace="2"
                                         src="<?php echo base_url() . "assets/imagenes/add_user.png" ?>"
                                         style="width:25px">
                                    <br/>
                                    Agregar Maestro</a>
                            </div>
