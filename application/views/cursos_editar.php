...
<script type="text/javascript" src="<?php echo base_url() . "assets/js/custom/cursos_editar.js" ?>"></script>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="form_add" data-toggle="validator">
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-lg-10">
                                                <input type="text" class="form-control" id="id_curso"
                                                       ...
                                                       value="<?php echo utf8_encode($resultado->nombre); ?>">
                                        ...
                                        <div class="form-group has-feedback">
                                            ...
                                            <div class="col-lg-10">
                                                <select name="tipo" id="id_tipo" aria-controls="datatable"
                                                    ...
                                                    <option value="Programación" <?php
                                                    if (utf8_encode($resultado->tipo) == 'Programación') {
                                                        ?>
                                                        selected="selected"
                                                    <?php
                                                    }
                                                    ...
                                                    <option value="Matemáticas" <?php
                                                    if (utf8_encode($resultado->tipo) == 'Matemáticas') {
                                                        ?>
                                                        selected="selected"
                                                    <?php
                                                    }
                                                    ...
                                                    <option value="Ingeniería de Software" <?php
                                                    if (utf8_encode($resultado->tipo) == 'Ingeniería de Software') {
                                                        ?>
                                                        selected="selected"
                                                    <?php
                                                    }
                                                    ...
                                                    if (utf8_encode($resultado->tipo) == 'Hardware') {
                                                        ?>
                                                        selected="selected"
                                                    <?php
                                                    }
                                        ...
                                        <input type="hidden" name="id_oculto"
                                               value="<?php echo $resultado->id_curso; ?>"/>
                                    </form>
                                </div>
                            </div>
                        </div>
